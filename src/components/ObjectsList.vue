            ...
            <div class="flex flex-col">
                ...
                <div class="mt-4 flex flex-row-reverse">
                    <button
                        @click="addObject"
                        type="button"
                        class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-green-500 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-800"
                    >
                        Добавить объект
                    </button>
                </div>
